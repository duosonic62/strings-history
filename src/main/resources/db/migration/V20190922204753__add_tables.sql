...
CREATE TABLE guitar
(
    id          VARCHAR(32)  NOT NULL comment 'ギターid',
    member_id   VARCHAR(32)  NOT NULL comment 'メンバーid(外部キー)',
...
(
    id           VARCHAR(32) NOT NULL comment '弦交換id',
    string_id    VARCHAR(32) NOT NULL comment '弦id',
    guitar_id    VARCHAR(32) NOT NULL comment 'ギターid',
